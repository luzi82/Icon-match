...
//	}
	...
	public static IconPackEntry loadZipEntry(File file) {
		try {
			ZipFile zf = new ZipFile(file);

			ZipEntry ze = zf.getEntry("data.xml");
			if (ze == null) {
				System.err.println("ze==null");
				zf.close();
				return null;
			}
			...
			sp.parse(zf.getInputStream(ze), dxch);
...
//			}
	...
	private static class DataXmlContentHandler extends DefaultHandler {
